...
const getFancyQuote = (points: number): string => {
    ...
    if (points < 10) {
        return "🎉 You gained points! " +
            "Couple of lucky picks? Amad (c) for the hattrick?";
    }
...
const FancySummary: React.FC<FancySummaryProps> = ({ points }) => {
    const quote = getFancyQuote(points);
